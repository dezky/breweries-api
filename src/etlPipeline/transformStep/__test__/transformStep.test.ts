import { transformBreweries } from '..';
...
test('should transform breweries', () => {
  const result = transformBreweries(breweriesInput);
  expect(result).toEqual(transformedBreweries);
});
