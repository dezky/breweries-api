...
import { PartialBreweryResponseItem, BreweryResponseItem } from '../../../../types';
...
const breweriesOutput: PartialBreweryResponseItem[] = [
  {
    id: 'banjo-brewing-fayetteville',
    name: 'Banjo Brewing',
    brewery_type: 'planning',
...
test('removeNullProperties', () => {
  const result = removeNullProperties(breweriesInput);
